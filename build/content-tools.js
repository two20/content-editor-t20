...
(function() {
  ...
  ContentTools.IgnitionUI = (function(_super) {
    ...
    IgnitionUI.prototype.mount = function() {
      var ignitionSettings;
      IgnitionUI.__super__.mount.call(this);
      this._domElement = this.constructor.createDiv(['ct-widget', 'ct-ignition', 'ct-ignition--ready']);
      ignitionSettings = this.parent().ignitionSettings();
      if (ignitionSettings.dom !== null) {
        document.getElementById(ignitionSettings.dom).appendChild(this._domElement);
      } else {
        this.parent().domElement().appendChild(this._domElement);
      }
      this._domEdit = this.constructor.createDiv(['ct-ignition__button', 'ct-ignition__button--edit']);
      if (ignitionSettings.buttons.edit.content) {
        this._domEdit.innerHTML = ignitionSettings.buttons.edit.content;
      }
      ...
      if (ignitionSettings.buttons.confirm.content) {
        this._domConfirm.innerHTML = ignitionSettings.buttons.confirm.content;
      }
      ...
      if (ignitionSettings.buttons.cancel.content) {
        this._domCancel.innerHTML = ignitionSettings.buttons.cancel.content;
      }
      ...
      if (ignitionSettings.buttons.busy.content) {
        this._domBusy.innerHTML = ignitionSettings.buttons.busy.content;
      }
  ...
  ContentTools.InspectorUI = (function(_super) {
    ...
    InspectorUI.prototype.mount = function() {
      ...
      inspectorSettings = this.parent().inspectorSettings();
      if (inspectorSettings.dom !== null) {
        document.getElementById(inspectorSettings.dom).appendChild(this._domElement);
      } else {
        this.parent().domElement().appendChild(this._domElement);
      }
  ...
  _EditorApp = (function(_super) {
    ...
    function _EditorApp() {
      ...
      this._ignitionSettings = null;
      this._inspectorSettings = null;
    }
    ...
    _EditorApp.prototype.init = function(queryOrDOMElements, namingProp, fixtureTest, ignitionSettings, inspectorSettings) {
      if (namingProp == null) {
        namingProp = 'id';
      }
      if (fixtureTest == null) {
      ...
      if (ignitionSettings == null) {
        ignitionSettings = null;
      }
      ...
      this.mount();
      this.initIgnitionSettings(ignitionSettings);
      this.initInspectorSettings(inspectorSettings);
      if (this._ignitionSettings.enable) {
    ...
    _EditorApp.prototype.ignitionElement = function() {
      return this._ignitionElement;
    };

    _EditorApp.prototype.ignitionDefaults = function() {
      var defaultSettings;
    ...
    _EditorApp.prototype.ignitionSettings = function() {
      return this._ignitionSettings;
    };

    _EditorApp.prototype.initIgnitionSettings = function(settings) {
      if (settings === null) {
        return this.ignitionDefaults();
      }
      this._ignitionSettings = deepmerge(this.ignitionDefaults(), settings);
      return this._ignitionSettings;
    };

    _EditorApp.prototype.inspectorDefaults = function() {
      var defaultSettings;
      return defaultSettings = {
        dom: null
      };
    ...
    _EditorApp.prototype.inspectorSettings = function() {
      return this._inspectorSettings;
    };

    _EditorApp.prototype.initInspectorSettings = function(settings) {
      if (settings === null) {
        return this.inspectorDefaults();
      }
      this._inspectorSettings = deepmerge(this.inspectorDefaults(), settings);
      return this._inspectorSettings;
    };
