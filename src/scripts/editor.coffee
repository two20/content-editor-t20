class _EditorApp extends ContentTools.ComponentUI
    ...
    constructor: () ->
        ...
        @_ignitionSettings = null
        @_inspectorSettings = null
    ...
    init: (
        ...
        #    @_ignitionSettings = @ignitionDefaults()
        #else
        #    @_ignitionSettings = ignitionSettings
        @initIgnitionSettings(ignitionSettings)
        @initInspectorSettings(inspectorSettings)
        if @_ignitionSettings.enable
        ...
        defaultSettings =
            ...
            buttons:
                ...
                busy:
                    content:null
    ignitionSettings: () ->
        return @_ignitionSettings

    initIgnitionSettings: (settings) ->
        if settings == null
            return @ignitionDefaults()
        @_ignitionSettings = deepmerge(@ignitionDefaults(),settings)
        return @_ignitionSettings
    ...
    inspectorDefaults: () ->
        defaultSettings =
            dom: null
    inspectorSettings: () ->
        return @_inspectorSettings

    initInspectorSettings: (settings) ->
        if settings == null
            return @inspectorDefaults()
        @_inspectorSettings = deepmerge(@inspectorDefaults(),settings)
        return @_inspectorSettings
