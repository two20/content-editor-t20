class ContentTools.IgnitionUI extends ContentTools.WidgetUI
    ...
    mount: () ->
        ...
        ignitionSettings = @parent().ignitionSettings()
        if ignitionSettings.dom != null
            document.getElementById(ignitionSettings.dom).appendChild(@_domElement)
        else
        ...
        if ignitionSettings.buttons.edit.content
            @_domEdit.innerHTML = ignitionSettings.buttons.edit.content
        ...
        if ignitionSettings.buttons.confirm.content
            @_domConfirm.innerHTML = ignitionSettings.buttons.confirm.content
        ...
        if ignitionSettings.buttons.cancel.content
            @_domCancel.innerHTML = ignitionSettings.buttons.cancel.content
        ...
        if ignitionSettings.buttons.busy.content
            @_domBusy.innerHTML = ignitionSettings.buttons.busy.content
